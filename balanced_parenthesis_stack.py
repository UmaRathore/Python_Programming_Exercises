...
# We consider two brackets to be matching if the first bracket is an open-bracket, e.g., (, {, or [,
# and the second bracket is a close-bracket of the same type. That means ( and ), [ and ], and { and } are
